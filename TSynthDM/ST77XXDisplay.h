...
// DH adding OSCA,OSCB strings for DKplus
String currentOSCA = "A";
String currentOSCB = "B";
...
FLASHMEM void renderBootUpPage()
{
  ...
  tft.setFont(&FreeSans9pt7b);
  tft.setCursor(5, 145);
  tft.println("20201212DM");
  
  tft.drawLine(5, 170, 235 , 170, ST77XX_CYAN);
...
FLASHMEM void renderPeak() {
  ...
  if (vuMeter && peak.available()) {
    ...
    tft.drawFastVLine((Vux), Vuy - len ,redlen , ST7735_RED);
    tft.drawFastVLine((Vux), Vuy - Redlev, Yellowlev , ST7735_YELLOW);
    tft.drawFastVLine((Vux), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    if(ST77XXDisplayType > 1){
      tft.drawFastVLine((Vux+1), Vuy - len ,redlen , ST7735_RED);
    tft.drawFastVLine((Vux+1), Vuy - Redlev, Yellowlev , ST7735_YELLOW);
    tft.drawFastVLine((Vux+1), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    tft.drawFastVLine((Vux+2), Vuy - len ,redlen , ST7735_RED);
    tft.drawFastVLine((Vux+2), Vuy - Redlev, Yellowlev , ST7735_YELLOW);
    tft.drawFastVLine((Vux+2), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    tft.drawFastVLine((Vux+3), Vuy - len ,redlen , ST7735_RED);
    tft.drawFastVLine((Vux+3), Vuy - Redlev, Yellowlev , ST7735_YELLOW);
    tft.drawFastVLine((Vux+3), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    tft.drawFastVLine((Vux+4), Vuy - len ,redlen , ST7735_RED);
    tft.drawFastVLine((Vux+4), Vuy - Redlev, Yellowlev , ST7735_YELLOW);
    tft.drawFastVLine((Vux+4), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    }
      ...
      tft.drawFastVLine(Vux, Vuy - len ,yellowlen , ST7735_YELLOW);
      tft.drawFastVLine(Vux, Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
      if(ST77XXDisplayType > 1){
        tft.drawFastVLine((Vux+1), Vuy - len ,yellowlen , ST7735_YELLOW);
        tft.drawFastVLine((Vux+1), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    
        tft.drawFastVLine((Vux+2), Vuy - len ,yellowlen , ST7735_YELLOW);
        tft.drawFastVLine((Vux+2), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
    
        tft.drawFastVLine((Vux+3), Vuy - len ,yellowlen , ST7735_YELLOW);
        tft.drawFastVLine((Vux+3), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
        tft.drawFastVLine((Vux+4), Vuy - len ,yellowlen , ST7735_YELLOW);
        tft.drawFastVLine((Vux+4), Vuy - Yellowlev, Yellowlev , ST7735_GREEN);
        }
      ...
      tft.drawFastVLine(Vux, Vuy - len, len ,  len > Redlev ? ST7735_RED : ST7735_GREEN);
      if(ST77XXDisplayType > 1){
        tft.drawFastVLine((Vux+1), Vuy - len, len ,  len > Redlev ? ST7735_RED : ST7735_GREEN);
        tft.drawFastVLine((Vux+2), Vuy - len, len ,  len > Redlev ? ST7735_RED : ST7735_GREEN);
        tft.drawFastVLine((Vux+3), Vuy - len, len ,  len > Redlev ? ST7735_RED : ST7735_GREEN);
        tft.drawFastVLine((Vux+4), Vuy - len, len ,  len > Redlev ? ST7735_RED : ST7735_GREEN);
      }
    }
...
FLASHMEM void renderCurrentPatchPage() {
  ...
  */
  ...
  tft.println(currentOSCA);
  tft.setTextColor(ST7735_CYAN);
  tft.setCursor(10, 230);
  tft.println(currentOSCB);
  
  tft.drawLine(10, 237, 237, 237, ST7735_CYAN);
  }
}
...
void displayThread() {
  threads.delay(3000); //Give bootup page chance to display
  while (1) {
    switch (state) {
      case PARAMETER:
