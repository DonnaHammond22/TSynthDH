...
//#define ST7735Display 1
#define ST7789Display 2

#define INIT_ST7789_TABCOLOR 42  // Not used except as a indicator to the code... 
// DH overridding for 240
#define ST7735_TFTWIDTH  240
#define ST7735_TFTWIDTH_80     240 // for mini

// for 1.44" display
#define ST7735_TFTHEIGHT_144 128
// for 1.8" display and mini
#define ST7735_TFTHEIGHT_160  160 // for 1.8" and mini display
//DH Display options referenced to ST77XXDisplayType
#define ST7735_TFTHEIGHT1 80     // for TSynth Standard display
#define ST7735_TFTWIDTH1 160 

#define ST7789_TFTHEIGHT2 240     // for Pimoroni display 1.3 inch 240 x 240 
#define ST7789_TFTWIDTH2 240 
#define ST7789_TFTHEIGHT3 240     // for Ada fruit display 1.54 inch 240 x 240
#define ST7789_TFTWIDTH3 240 

#define ST7789_TFTHEIGHT4 320     // for ADA fruit display 2.2 inch 240 x 320
#define ST7789_TFTWIDTH4 240 
// DH End of ST77XXDisplayType options
...
// DH conditional Colour mapping definitions for ST7735 and ST7789 

#if defined(ST7735Display)
...
// DH check why following are not recognised ?
...
#define ST77XX_DMA_BUFFER_SIZE 1024
typedef struct {
...
class ST7735_t3 : public Adafruit_GFX {
 ...
 public:
  ...
  void     initB(void),                             // for ST7735B displays
		   ...
		   init(uint16_t width=240, uint16_t height=240, uint8_t mode=SPI_MODE0),//DH for ST7789
